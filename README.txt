...
The development version of this mod is available on [url=https://github.com/Lyther/UnlimitedBuildings]GitHub[/url] for real-time updates. If you want to play the latest development version instead of the stable release, you can use `git pull` to get the latest commit from the GitHub repository.
...
[quote]If you don't need this feature, delete the `common/megastructures` folder in the mod directory.[/quote]

[list]
[*] [b]Ring World[/b]: Unlocked the limit on building in galaxy types (binary stars, triple stars, black holes), construction won't affect other planets in the system, won't clear the galaxy upon completion, and can be stacked infinitely.
[*] [b]Dyson Sphere[/b]: Unlocked the limit on building in galaxy types (binary stars, triple stars, black holes), construction won't affect planets in the system, all habitable planets are preserved, and it can be stacked infinitely.
[*] [b]Matter Decompressor[/b]: Unlocked the limit on building in galaxy types (binary stars, triple stars, black holes), and it can be stacked infinitely.
[*] [b]All Planetary Star Megastructures[/b]: Can be built on planetary moons and stacked infinitely.
[*] [b]Habitable Stations[/b]: Can be built on planetary moons, stacked infinitely, and built on ringworld sections. Research, energy, mining districts, and rare resource gathering buildings are all unlocked by default.
[*] [b]Star Ring Base[/b]: Can be built on uncolonized habitable planets or restored on previously uncolonized planets.
[/list]

[quote]Note: Most megastructures allow AI empires to only build one; in rare cases, AI empires (especially Fallen Empires) may still build multiple megastructures.[/quote]
...
[b]Please note:[/b] When sorting mods, place Unlimited Buildings below other mods that require compatibility.
...
[center][size=18]无限建筑&巨构[/size][/center]

此MOD的开发版本将在[url=https://github.com/Lyther/UnlimitedBuildings]GitHub[/url]进行实时更新，如果您想游玩最新的开发版本而非稳定版本，可以通过GitHub仓库的`git pull`获取最新的commit。
...
[center][size=16]建筑解锁[/size][/center]
...
[center][size=16]巨构建筑[/size][/center]

全部巨构建筑均可以无数量上限建造，且不再有同时建造的数量限制。

[quote]如果您不需要此功能，请在MOD目录下删除`common/megastructures`文件夹。[/quote]

[list]
[*] [b]环形世界[/b]：解锁了建造星系限制（双恒星、三恒星、黑洞），建造不会影响星系内其他星球，建造完成不会清空星系，可以无限堆叠。
[*] [b]戴森球[/b]：解锁了建造星系限制（双恒星、三恒星、黑洞），建造完成后不会影响星系内行星，宜居球全部保留，可以无限堆叠。
[*] [b]物质解压器[/b]：解锁了建造星系限制（双恒星、三恒星、黑洞），可以无限堆叠。
[*] [b]所有行星级巨构[/b]：可以在星球的卫星上建造，可以无限堆叠。
[*] [b]居住站[/b]：可以在星球的卫星上建造，可以无限堆叠，可以在环形世界的区段上建造，默认解锁研究、发电、采矿区划，且可以建造稀有资源采集建筑。
[*] [b]星环基地[/b]：可以在无人居住的宜居球上建造，或是修复未殖民星球上的星环基地。
[/list]

[quote]注意：大部分的巨构建筑仅允许AI帝国建造一个，少数情况下仍会出现AI帝国（尤其是复兴帝国）建造多个巨构的现象。[/quote]

[center][size=16]更新/兼容[/size][/center]
...
[b]请注意：[/b]排序时需要将无限建筑放置于其他需要兼容的MOD之下。

[center][size=16]自动进行MOD兼容[/size][/center]
